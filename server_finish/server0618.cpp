        ...
        // 사장 주문 조회 요청 처리
            ...
            // 쿼리 ORDER_ 테이블
                ...
                while ((r1 = mysql_fetch_row(res1))) {
                    ...
                    cJSON_AddStringToObject(o, "order_id", r1[0]);
                    cJSON_AddNumberToObject(o, "brand_uid", atoi(r1[1]));
                    cJSON_AddNumberToObject(o, "place_uid", atoi(r1[2]));
                    cJSON_AddNumberToObject(o, "total_price", atoi(r1[3]));
                    cJSON_AddStringToObject(o, "order_time", r1[4]);
                    ...
                    cJSON_AddNumberToObject(o, "status_togo",       atoi(r1[9]));
                    cJSON_AddNumberToObject(o, "status_disposible", atoi(r1[10]));
                    cJSON_AddNumberToObject(o, "status_order",      atoi(r1[11]));  
        ...
        // 주문 조회 요청 10_0 처리
            ...
            if (uid && cJSON_IsString(uid)) {
                ...
                while ((r1 = mysql_fetch_row(res1))) {
                    ...
                    cJSON_AddStringToObject(o, "address",         r1[5] ? r1[5] : "");
                    cJSON_AddStringToObject(o, "address_detail",  r1[6] ? r1[6] : "");
                    cJSON_AddStringToObject(o, "order_msg",       r1[7]);
                    cJSON_AddStringToObject(o, "rider_msg",       r1[8]);
                    cJSON_AddNumberToObject(o, "status_togo",      atoi(r1[9]));
                    cJSON_AddNumberToObject(o, "status_disposible",atoi(r1[10]));
                    cJSON_AddNumberToObject(o, "status_order",      atoi(r1[11]));
